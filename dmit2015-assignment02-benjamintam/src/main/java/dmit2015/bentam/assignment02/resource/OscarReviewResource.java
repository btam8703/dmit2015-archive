/*
 * Read all reviews
 curl -i -X GET http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews
 *
 * Read a single review
 curl -i -X GET http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews/2
 *
 * Create new reviews
 curl -i -X POST http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews \
 ...
 *
 ...
 curl -i -X GET http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews/6
 curl -i -X GET http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews/7
 *
 * Updating a review
 ...
 *
 * Delete a review
 curl -i -X DELETE http://localhost:8080/dmit2015-assignment02-benjamintam/webapi/reviews/5
 *
 *
 */

package dmit2015.bentam.assignment02.resource;

import dmit2015.bentam.assignment02.entity.OscarReview;
import dmit2015.bentam.assignment02.repository.OscarReviewRepository;
