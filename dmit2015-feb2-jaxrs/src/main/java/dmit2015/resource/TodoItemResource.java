 ...
 *
 ...
 curl -i -X GET http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems

 curl -i -X GET http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems/1

 curl -i -X POST http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems \
 -d '{"name":"Submit DMIT2015 Assignment 7","complete":false}' \
 -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems/5

 curl -i -X PUT http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems/5 \
 -d '{"id":5,"name":"Submitted DMIT2015 assignment 7","complete":true}' \
 -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems/5

 curl -i -X DELETE http://localhost:8080/dmit2015-feb-jaxrs-demo/webapi/TodoItems/5
...
public class TodoItemResource {
    ...
    @Path("{id}")
    public Response getTodoItem(@PathParam("id") Long id, @Valid TodoItem updatedTodoItem) {
